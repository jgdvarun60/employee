  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ff4JApp.location.home.createOrEditLabel">Create or edit a Location</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : locationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="location-country" type="select" className="form-control" name="countryId">
                  <option value="" key="0" />
                  {countries
