  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ff4JApp.department.home.createOrEditLabel">Create or edit a Department</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : departmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="department-location" type="select" className="form-control" name="locationId">
                  <option value="" key="0" />
                  {locations
